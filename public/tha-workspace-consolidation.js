(() => {
  ...
  function arrangeImportPanel(body, setup) {
    ...
    if (heading) heading.textContent = '2. Homeowner Intake';
  ...
  function simplifyControls() {
    document.querySelectorAll('.walkthroughControlsPanel').forEach(panel => {
      ...
      if (subhead) subhead.textContent = panel.classList.contains('collapsed')
        ? 'Open only when you need setup, homeowner-intake, work-session, or record tools.'
        : 'Set up the walkthrough, import homeowner intake context, manage the working session, and save internal records.';
      ...
      renameHeading(panel, 'Send / Import Homeowner Intake', '2. Homeowner Intake');
      renameHeading(panel, 'Homeowner Intake', '2. Homeowner Intake');
      renameHeading(panel, '3. Homeowner Intake', '2. Homeowner Intake');
      renameHeading(panel, '1. Local Work / This Device', '3. Work Session');
      renameHeading(panel, 'Local Work / This Device', '3. Work Session');
      renameHeading(panel, '2. Work Session', '3. Work Session');
